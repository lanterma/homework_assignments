...
puts "There are #{seconds_in_a_minute} in a minute"
puts "There are #{minutes_in_a_hour} in a hour"
puts "There are #{hours_in_a_day} in a day"
puts "There are #{days_in_a_week}in a week"
